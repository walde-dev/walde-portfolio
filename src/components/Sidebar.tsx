            ...
            <SocialLogo
              logo={
                <div className="flex flex-row justify-center items-center space-x-4">
                  ...
                  <span className="py-1 px-2 text-base duration-300 transition-all ease-in opacity-0 group-hover:opacity-100 dark:text-violet-400 text-violet-500 font-semibold bg-gradient-to-r from-[#9f6deab8] to-[#7971eec4] rounded-md">Soon!</span>
                </div>
              }

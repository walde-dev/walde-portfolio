...
export default function InfoBanner() {
  return (
    <Fade big cascade triggerOnce delay={1000}>
      <div className="flex w-full max-w-[1200px] translate-y-[200%] flex-row items-center justify-between space-x-7 rounded-lg border border-zinc-700 bg-zinc-800 bg-opacity-60 px-6 py-3 text-sm opacity-80 shadow-xl backdrop-blur-lg">

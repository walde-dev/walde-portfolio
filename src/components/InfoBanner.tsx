...
export default function InfoBanner() {
  return (
    <Fade big cascade triggerOnce delay={1000}>
      <div className="flex w-full max-w-[300px] md:max-w-[600px] translate-y-[70%] flex-col items-center justify-between space-y-3 space-x-2 rounded-lg border border-zinc-700 bg-zinc-800 bg-opacity-60 px-3 py-2 text-xs opacity-80 shadow-xl backdrop-blur-lg transition-all duration-150 ease-in-out hover:opacity-100 lg:max-w-[1200px] md:translate-y-[200%] md:flex-row md:space-y-0 md:space-x-7 md:px-6 md:py-3 md:text-sm">
